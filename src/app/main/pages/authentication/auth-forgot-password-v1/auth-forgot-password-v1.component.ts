...
export class AuthForgotPasswordV1Component implements OnInit {
   ...
   *
   */
  constructor(private _coreConfigService: CoreConfigService, private _formBuilder: FormBuilder,private authService:AuthService) {
  ...
  onSubmit() {
    ...
    let email=this.forgotPasswordForm.getRawValue()
    console.log(email)
    this.authService.getLinkReset(email).subscribe((res)=>{
